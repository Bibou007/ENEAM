...
<head>
    ...
    <title>ENEAM - Tableau d'Administration </title>
    <!-- Favicon icon -->
    ...
    <link rel="stylesheet" href="{{ asset('admin_assets/css/skin-2.css') }}">
...
<body>
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="#" class="brand-logo"
                style=" font-size:45px;letter-space:10px; font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif">
                &nbsp; ENEAM
            </a>
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="" href="{{ route('admin') }}" aria-expanded="false">
                    ...
                    <li><a class="has-arrow" href="{{ route('all-directeur') }}" aria-expanded="false">
                            <i class="la la-user"></i>
                            <span class="nav-text">Directeurs</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="{{ route('all-directeur') }}">Tous les directeurs</a></li>
                            <li><a href="{{ route('add-directeur') }}">Ajouter un directeur</a></li>
                            {{-- <li><a href="{{route('edit-evenement')}}">Modifier un évènement</a></li> --}}

                        </ul>
                    </li>
                    <li><a class="has-arrow" href="{{ route('all-evenement') }}" aria-expanded="false">
                            <i class="la la-calendar"></i>
                            <span class="nav-text">Evènements</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="{{ route('all-evenement') }}">Tous les évènements</a></li>
                            <li><a href="{{ route('add-evenement') }}">Ajouter un évènement</a></li>
                            {{-- <li><a href="{{route('edit-evenement')}}">Modifier un évènement</a></li> --}}
       ...
       <span class="nav-text">Students</span>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="#">A propos d'un Etudiant</a></li>
                        </ul>
                    </li> -->
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="la la-graduation-cap"></i>
                            <span class="nav-text">Procès Verbaux</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="{{ route('all-pv') }}">Tous les PV</a></li>
                            <li><a href="{{ route('add-pv') }}">Ajouter un PV</a></li>
                            {{-- <li><a href="{{route('edit-pv')}}">Modifier un PV</a></li> --}}
       ...
       <span class="nav-text">Departments</span>
                    ...
                    <!-- <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
       <i class="la la-users"></i>
       <span class="nav-text">Administrations</span>
      </a>
                        <ul aria-expanded="false">
                            <li><a href="#">Listes Administration</a></li>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="#" target="_blank">Boss Bibs 😎😎</a>- 2023
                </p>
            </div>
        </div>
        <!--**********************************
    ...
    ***********************************-->
    ...
    <script src="{{ asset('admin_assets/vendor/jquery-sparkline/jquery.sparkline.min.js') }}"></script>

    <!-- Demo scripts -->
    <script src="{{ asset('admin_assets/js/dashboard/dashboard-3.js') }}"></script>
