...
<section class="about">
    ...
    <div class="image">
       <img src="{{asset('CLIENT_ASSETS/images/bue.png')}}" alt="">
    </div>
 
    <div class="content">
       <h3 class="about-title">A Propos du BUE</h3>
 ...
 <section id="directeurs" class="">
    ...
    <div class="owl-carousel owl-theme" id="actu-slide">
        ...
        <div class="card mb-4">
            <div class="image">
                <img src="{{asset('CLIENT_ASSETS/images/omar.jpg')}}" height="450" alt="">
                
             </div>
             <div class="content">
                <h3>GBADAMASSI Omar</h3>
                <span>Président</span>
             </div>
