    ...
    <header class="py-5 bg-light border-bottom mb-4">
        <div class="container">
            <div class="text-center my-5">
                <h1 class="fw-bolder">Consulter ici les derniers procès verbaux publiés</h1>
                        ...
                        <div class="col-xl-6">
                            ...
                            <div class="card mb-4">
                                <a href="#!"><img class="card-img-top"
                                        src="{{ asset('CLIENT_ASSETS/images/communique.png') }}" height="150"
                                        width="300" alt="..." /></a>
                                <div class="card-body">
                                    <div class="small text-muted">Posté le {{ $pv->created_at->format('D M Y') }}</div>
                                    <h2 class="card-title h4">{{ $pv->annee }}- {{$pv->filiere}}-{{$pv->mode_cours}}</h2>

                                    
                                    <a class="btn btn-primary full-width" href="{{url('show-consultation/'.$pv->id)}}">Consulter →</a>
